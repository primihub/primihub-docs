...
description: 介绍 PrimiHub Python SDK 的用法
---
...
- 安装了 PrimiHub Python SDK
- 使用 `docker-compose` 启动节点应用，参考[快速开始](https://docs.primihub.com/docs/quick-start)

## Python Client 初始化

1. 新建 `Python` 文件
1. 在文件开头引入 `primihub_cli`
...
3. Client 初始化,输入正确的 `node` 信息，和证书地址（TODO）
